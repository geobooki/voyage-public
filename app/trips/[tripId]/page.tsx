...
function TripPageContent() {
  ...
  const { state, addReservation, updateReservation, addSchedule } = useTripData();
          ...
          {scheduleDates.length ? (
            <>
              ...
              <div className="hidden md:block">
                <TripScheduleCalendar dates={visibleScheduleDates} schedule={state.schedule} reservations={state.reservations} ko={ko} onAdd={openSchedule} onReservationClick={editQuickReservation} />
              </div>
              <div className="md:hidden">
                <TripScheduleCalendar dates={[scheduleDates[mobileSchedulePage]]} schedule={state.schedule} reservations={state.reservations} ko={ko} onAdd={openSchedule} onReservationClick={editQuickReservation} />
              </div>
            </>
