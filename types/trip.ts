...
export type Expense = { id: string; amount: number; currency: string; category: string; placeId?: string; payerId?: string; memo: string; date: string; time: string; krwAmount?: number };
