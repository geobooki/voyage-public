...
export type Expense = { id: string; name?: string; amount: number; currency: string; category: string; paymentMethod?: string; placeId?: string; payerId?: string; memo: string; date: string; time: string; krwAmount?: number };
