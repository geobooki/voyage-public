...
const ko: Record<string, string> = {
  ...
  "Let’s get ready.": "여행 준비를 시작해요.", "A calm trip starts with a clear plan. Your progress is saved on this device.": "차분한 여행은 명확한 계획에서 시작됩니다. 진행 상황은 이 기기에 저장됩니다.", "Packing list": "준비물 목록", "Take what you need": "필요한 것을 챙겨요", "Add an item": "항목 추가", "Estimated budget": "예상 예산", "Manage budget →": "예산 관리 →", confirmed: "확정", "Date to be confirmed": "날짜 확인 중", "Reservation name": "예약 이름", "Cost (KRW)": "비용 (원)", "Save reservation": "예약 저장", "Currency plan": "환전 계획", "Plan your exchange": "환전 계획 세우기", "Budget details →": "예산 상세 →", "Save currency plan": "환전 계획 저장",
  "Manual rate for MVP": "MVP용 수동 환율", From: "출발 통화", To: "도착 통화", Rate: "환율", "Expected cash": "예상 현금", "Card estimate": "카드 예상액", "Actual exchanged": "실제 환전액",
  "Reservation tracker": "예약 관리", "Add reservation": "예약 추가", "Confirmation number": "예약 번호", Flight: "항공편", Hotel: "호텔", Activity: "활동",
